...
namespace FUIEditor
{
    ...
    public static class FUICodeSpawner
    {
        ...
        // 代码生成路径
        public const string FUIAutoGenDir = "../Unity/Assets/Scripts/ModelView/Client/Demo/FUIAutoGen";
        public const string ModelViewCodeDir = "../Unity/Assets/Scripts/ModelView/Client/Demo/FUI";
        public const string HotfixViewCodeDir = "../Unity/Assets/Scripts/HotfixView/Client/Demo/FUI";
        ...
        public static void FUICodeSpawn(string[] packageNames)
        {
            ParseAndSpawnCode(packageNames);

            AssetDatabase.Refresh();
        }
        
        public static void FUICodeSpawn(string packageName, string[] packageNames)
        {
            ParseAndSpawnCode(packageName, packageNames);

            AssetDatabase.Refresh();
        }

        private static void ParseAndSpawnCode(string[] packageNames)
        {
            ParseAllPackages(packageNames);
            AfterParseAllPackages();
            SpawnCode();
        }
        
        private static void ParseAndSpawnCode(string packageName, string[] packageNames)
        {
            ParseAllPackages(packageNames);
            AfterParseAllPackages();
        ...
        private static void ParseAllPackages(string[] packageNames)
        {
            PackageInfos.Clear();
            ...
            string fuiAssetsDir = $"{Application.dataPath}/../../Art/FGUIProject/assets";
        ...
        private static void SpawnCode()
        {
            ...
            Directory.CreateDirectory(FUIAutoGenDir);
