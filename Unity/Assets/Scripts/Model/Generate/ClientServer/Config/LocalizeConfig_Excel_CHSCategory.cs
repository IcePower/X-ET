...
{
    [Config]
    public partial class LocalizeConfig_Excel_CHSCategory : ConfigSingleton<LocalizeConfig_Excel_CHSCategory>
    {
        private readonly Dictionary<string, LocalizeConfig_CHS> _dataMap;
        private readonly List<LocalizeConfig_CHS> _dataList;

        public LocalizeConfig_Excel_CHSCategory(ByteBuf _buf)
        {
