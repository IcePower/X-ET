...
namespace ET.Client
{
    ...
    public static partial class FUIComponentSystem
    {
        ...
        public static void HidePanel<T, P1>(this FUIComponent self, P1 p1) where T : Entity
        {
            PanelId panelId = self.GetPanelIdByGeneric<T>();
            self.HidePanel<P1>(panelId, p1);
        }
        
        public static void HidePanel<P1>(this FUIComponent self, PanelId panelId, P1 p1)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelId);
        ...
        public static void HidePanel<T, P1, P2>(this FUIComponent self, P1 p1, P2 p2) where T: Entity
        {
            PanelId panelId = self.GetPanelIdByGeneric<T>();
            self.HidePanel(panelId, p1, p2);
        }
        
        public static void HidePanel<P1, P2>(this FUIComponent self, PanelId panelId, P1 p1, P2 p2)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelId);
        ...
        public static void HidePanel<T, P1, P2, P3>(this FUIComponent self, P1 p1, P2 p2, P3 p3) where T : Entity
        {
            PanelId panelId = self.GetPanelIdByGeneric<T>();
            self.HidePanel(panelId, p1, p2, p3);
        }
        
        public static void HidePanel<P1, P2, P3>(this FUIComponent self, PanelId panelId, P1 p1, P2 p2, P3 p3)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelId);
        ...
        public static void HidePanel<T, P1, P2, P3, P4>(this FUIComponent self, P1 p1, P2 p2, P3 p3, P4 p4) where T : Entity
        {
            PanelId panelId = self.GetPanelIdByGeneric<T>();
            self.HidePanel(panelId, p1, p2, p3, p4);
        }
        
        public static void HidePanel<P1, P2, P3, P4>(this FUIComponent self, PanelId panelId, P1 p1, P2 p2, P3 p3, P4 p4)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelId);
        ...
        public static void HidePanel<T, P1, P2, P3, P4, P5>(this FUIComponent self, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) where T : Entity
        {
            PanelId panelId = self.GetPanelIdByGeneric<T>();
            self.HidePanel(panelId, p1, p2, p3, p4, p5);
        }
        
        public static void HidePanel<P1, P2, P3, P4, P5>(this FUIComponent self, PanelId panelId, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelId);
        ...
        private static void SetPanelVisible(this FUIComponent self, FUIEntity fuiEntity)
        {
            ...
            self.VisiblePanelTypeDict.Add(fuiEntity.panelType, fuiEntity.PanelId);
        ...
        private static bool SetPanelHide(this FUIComponent self, FUIEntity fuiEntity)
        {
            ...
            self.VisiblePanelTypeDict.Remove(fuiEntity.panelType, fuiEntity.PanelId);
        ...
        public static void HideAllVisiblePanel(this FUIComponent self, bool includeFixed = false)
        {
            ...
            foreach (var kv in self.IdToEntity)
            {
                ...
                if (fuiEntity.panelType == UIPanelType.Fixed && !includeFixed)
                {
                    continue;
                }
