...
namespace FairyGUI
{
    ...
    // public delegate void LoadUICallback(GComponent ui);
    // public delegate void LoadUIHandler<T>(string componentName, long id, LoadUICallback callback);
    ...
    {
        // public static LoadUIHandler LoadUIFunc;
        ...
        // public async ETTask LoadUI(long entityId = 0)
        // {
        //     ETTask task = ETTask.Create(true);
        //
        //     if (!_created && Application.isPlaying)
        //     {
        //         LoadUIFunc(componentName, entityId, gComponent =>
        //         {
        //             SetUI(gComponent);
