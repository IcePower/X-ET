...
namespace FairyGUI.Dynamic
{
    public sealed partial class UIAssetManager : IUIAssetManager
    {
        ...
        // private void LoadUIFunc(string componentName, long id, LoadUICallback callback)
        // {
        //     if (m_AssetLoader == null)
        //         throw new Exception("请设置AssetLoader");
        //                     
        //     m_AssetLoader.LoadUI(componentName, id, callback);
        // }
