...
namespace FairyGUI.Dynamic
{
    ...
    public sealed class DelegateUIAssetLoader : IUIAssetLoader
    {
        ...
        // public LoadUIHandler LoadUIHandlerImpl { get; set; }
        ...
        // public void LoadUI(string componentName, long id, LoadUICallback callback)
        // {
        //     if (LoadUIHandlerImpl == null)
        //     {
        //         throw new NotImplementedException();
        //     }
        //
        //     LoadUIHandlerImpl(componentName, id,callback);
        // }
    }
}